...
const uploadResumeToS3 = async (candidateId, fileName, buffer, mimetype) => {
    return new Promise((resolve, reject) => {
        const s3Key = `${awsS3Config_1.candidateFolder}/${candidateId}/resumes/${fileName}`;
        const params = {
...
exports.default = { uploadResumeToS3 };
