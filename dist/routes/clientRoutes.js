...
const clientSchema_1 = __importDefault(require("../middlewares/schemas/clientSchema"));
const clientLoginSchema_1 = __importDefault(require("../middlewares/schemas/clientLoginSchema"));
const createJobSchema_1 = __importDefault(require("../middlewares/schemas/createJobSchema"));
const updateJobSchema_1 = __importDefault(require("../middlewares/schemas/updateJobSchema"));
const updateClientProfileSchema_1 = __importDefault(require("../middlewares/schemas/updateClientProfileSchema"));
const sendOTPSchema_1 = __importDefault(require("../middlewares/schemas/sendOTPSchema"));
const validateForgetPasswordOTPSchema_1 = __importDefault(require("../middlewares/schemas/validateForgetPasswordOTPSchema"));
const updateClientPasswordSchema_1 = __importDefault(require("../middlewares/schemas/updateClientPasswordSchema"));
const validateJWT_1 = __importDefault(require("../middlewares/validateJWT"));
const clientPermission_1 = __importDefault(require("../middlewares/clientPermission"));
const uploadLogoMiddleware_1 = __importDefault(require("../middlewares/uploadLogoMiddleware"));
 ...
 *                   example: Email already exists!
 */
ClientRouter.post('/registerclient', uploadLogoMiddleware_1.default.single('logo'), parseFormData_1.default, (0, validateRequest_1.default)(clientSchema_1.default), clientController_1.default.clientRegistration);
/**
 * @swagger
 * /loginclient:
 *   post:
 ...
 */
ClientRouter.post('/loginclient', (0, validateRequest_1.default)(clientLoginSchema_1.default), clientController_1.default.clientLogin);
/**
 * @swagger
 * /getclientprofile:
 *   get:
 ...
 */
ClientRouter.get('/getclientprofile', validateJWT_1.default, clientPermission_1.default, clientController_1.default.getClientById);
/**
 * @swagger
 * /updateclientprofile:
 *   put:
 ...
 */
ClientRouter.put('/updateclientprofile', validateJWT_1.default, clientPermission_1.default, uploadLogoMiddleware_1.default.single('logo'), parseFormData_1.default, (0, validateRequest_1.default)(updateClientProfileSchema_1.default), clientController_1.default.updateClientProfile);
/**
 * @swagger
 * /createjobbyclient:
 *   post:
 ...
 *                   example: "An error occurred while fetching jobs. Please try again later !"
 */
ClientRouter.get('/getjobbyclient/:jobId', validateJWT_1.default, clientPermission_1.default, clientController_1.default.getJobByClient);
/**
 * @swagger
 * /updatejobbyclient:
 *   put:
 ...
 */
ClientRouter.put('/updatejobbyclient', validateJWT_1.default, clientPermission_1.default, (0, validateRequest_1.default)(updateJobSchema_1.default), clientController_1.default.updateJobByClient);
/**
 * @swagger
 * /sendOTP:
 *   post:
 ...
 */
ClientRouter.post('/sendOTP', (0, validateRequest_1.default)(sendOTPSchema_1.default), clientController_1.default.sendForgetPasswordOTP);
/**
 * @swagger
 * /clientvalidateOTP:
 *   post:
 ...
 */
ClientRouter.post('/clientvalidateOTP', (0, validateRequest_1.default)(validateForgetPasswordOTPSchema_1.default), clientController_1.default.validateForgetPasswordOTP);
/**
 * @swagger
