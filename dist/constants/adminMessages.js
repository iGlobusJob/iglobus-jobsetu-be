...
exports.ERROR_MAPPING = exports.HTTP_STATUS = exports.ADMIN_ERROR_MESSAGES = exports.ADMIN_SUCCESS_MESSAGE = void 0;
exports.ADMIN_SUCCESS_MESSAGE = {
...
exports.ADMIN_ERROR_MESSAGES = {
    ...
    UPDATE_FAILED: 'An error occurred while updating client details. Please try again later !',
    CLIENT_NOT_FOUND: 'Client not found !',
    CLIENTS_FETCH_ERROR_MESSAGE: 'Error in fetching client details !',
    CLIENT_FETCH_FAILED: 'An error occurred while fetching client details. Please try again later !',
...
exports.ERROR_MAPPING = {
    'ADMIN_NOT_FOUND': { status: exports.HTTP_STATUS.NOT_FOUND, message: exports.ADMIN_ERROR_MESSAGES.ADMIN_NOT_FOUND },
    'BAD_CREDENTIALS': { status: exports.HTTP_STATUS.UNAUTHORIZED, message: exports.ADMIN_ERROR_MESSAGES.BAD_CREDENTIALS },
    'ADMIN_ALREADY_EXISTS': { status: exports.HTTP_STATUS.CONFLICT, message: exports.ADMIN_ERROR_MESSAGES.ADMIN_ALREADY_EXISTS },
    'RECRUITER_ALREADY_EXISTS': { status: exports.HTTP_STATUS.CONFLICT, message: exports.ADMIN_ERROR_MESSAGES.RECRUITER_ALREADY_EXISTS }
};
