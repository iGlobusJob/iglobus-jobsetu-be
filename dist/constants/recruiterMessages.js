...
exports.ERROR_MAPPING = exports.HTTP_STATUS = exports.RECRUITER_ERROR_MESSAGES = exports.RECRUITER_SUCCESS_MESSAGE = void 0;
exports.RECRUITER_SUCCESS_MESSAGE = {
...
exports.RECRUITER_ERROR_MESSAGES = {
    ...
    RECRUITER_FETCH_JOBS_FAILED: 'An error occurred while fetching jobs. Please try again later !',
    JOB_NOT_FOUND: 'Job not found !',
    JOB_FETCH_FAILED: 'An error occurred while fetching job details. Please try again later !',
    CLIENTS_FETCH_ERROR_MESSAGE: 'An error occurred while fetching client details !',
...
exports.ERROR_MAPPING = {
    RECRUITER_NOT_FOUND: {
        ...
        message: exports.RECRUITER_ERROR_MESSAGES.RECRUITER_NOT_FOUND,
    },
    BAD_CREDENTIALS: {
        status: exports.HTTP_STATUS.UNAUTHORIZED,
        message: exports.RECRUITER_ERROR_MESSAGES.BAD_CREDENTIALS,
    },
    JOB_NOT_FOUND: {
        status: exports.HTTP_STATUS.NOT_FOUND,
        message: exports.RECRUITER_ERROR_MESSAGES.JOB_NOT_FOUND,
    },
    CLIENT_NOT_FOUND: {
        status: exports.HTTP_STATUS.NOT_FOUND,
        message: exports.RECRUITER_ERROR_MESSAGES.CLIENT_NOT_FOUND,
    },
    CANDIDATE_NOT_FOUND: {
        status: exports.HTTP_STATUS.NOT_FOUND,
        message: exports.RECRUITER_ERROR_MESSAGES.CANDIDATE_NOT_FOUND,
    },
};
